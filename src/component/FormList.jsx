...
function FormList({ user, setUser, DeleteUser, UpdateUser, changeEvent, currentPage, loading, setLoading }) {
  React.useEffect(() => {
    async function FetchAPI() {
      const res = await fetch(
        `https://tony-auth-express-vdee-6j0s-fhovok9bu.vercel.app/api/member?page=${currentPage}&limit=2`
      );
        ...
        <div className="overflow-x-auto relative shadow-md sm:rounded-lg">
          <table className="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
              ...
              (<tr role="status" className="loading h-20">
